...
if (isset($_SESSION['all_permissions']) && $_SESSION['all_permissions'] === true) {
    ...
    if (!in_array('contacts', $userPerms)) {
        die("Access denied.");
    }
}
          ...
          <table class="table table-dark table-striped align-middle">
            ...
            <?php while($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                  <a href="contact_delete.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this message?')"><i class="bi bi-trash"></i></a>
                </td>
              </tr>
            <?php endwhile; ?>
            </tbody>
