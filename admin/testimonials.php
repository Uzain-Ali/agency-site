...
if (isset($_SESSION['all_permissions']) && $_SESSION['all_permissions'] === true) {
    ...
    if (!in_array('testimonials', $userPerms)) {
        die("Access denied.");
    }
}
          ...
          <table class="table table-dark table-striped align-middle">
            ...
            <?php while($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                  <?php if ($row['avatar']): ?>
                    <img src="../public/assets/testimonials/<?= htmlspecialchars($row['avatar']) ?>" alt="Avatar" style="width:40px;height:40px;border-radius:50%;">
                  <?php endif; ?>
                </td>
